...
const AuthorOtherPosts = ({ posts }) => {
  ...
  return (
    <div>
      ...
      >
       <Slider {...settings} className="flex bg-blue-400 overflow-hidden">
  {posts.map((post) => (
    <div key={post._id} className="h-full">
      {/* Make sure all posts get the same height */}
      <div className="w-full float-left pb-[100%] mb-[-100%] flex flex-col justify-between h-full bg-red-300">
        {/* Post Img & Title */}
