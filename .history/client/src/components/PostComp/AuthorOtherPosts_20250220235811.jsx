    ...
    <div>
      ...
      >
        <Slider {...settings}>
          {posts.map((post) => (
            <div key={post._id}>
              <div className="flex flex-col h-56 md:h-[280px] lg:h-56 justify-between">
                <div className="flex flex-col w-full gap-2">
                  ...
                  <Link
                    ...
                    className="text-2xl md:text-xl font-bigThird text-darkest hover:text-light text-ellipsis line-clamp-3 md:line-clamp-2"
                  >
                    {post.title}
                  </Link>
                </div>
