    ...
    <div>
      ...
      >
        <Slider {...settings} className="bg-blue-300">
          {posts.map((post) => (
            <div key={post._id} className="h-72 md:h-60">
              <div className="flex flex-col h-full justify-between bg-red-300">
                <div className="flex flex-col w-full gap-2">
                  ...
                  <Link
                    ...
                    className="text-lg lg:text-xl font-bigThird text-darkest hover:text-light text-ellipsis line-clamp-3 lg:line-clamp-2"
                  >
                    {post.title}
                  </Link>
                </div>
