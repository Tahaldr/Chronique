    ...
    <div>
      <Slider {...settings}>
        {posts.map((post) => (
          <div
            key={post._id}
            className="flex flex-col min-h-60 justify-between items-center bg-red-400"
          >
            <div className="flex flex-col gap-2">
              {/* Post Image */}
              <div className="aspect-[8/5] w-full border-[1px] border-opacity-30 border-dark flex-shrink-0 overflow-hidden">
                <img
                  src={post.postPic}
