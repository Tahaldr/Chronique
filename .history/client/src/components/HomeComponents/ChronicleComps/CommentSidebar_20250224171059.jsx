...
const CommentSidebar = ({ postId }) => {
  ...
  className="pointer-events-none bg-repeat-y absolute top-0 right-0 
    w-[583px] h-full sm:w-[150%]"  // Increase width on small screens
  draggable="false"
/>

<div className="absolute top-0 right-0 h-full overflow-scroll flex flex-col gap-5 
  w-[500px] px-5 py-5 
  sm:w-full sm:px-10">  {/* Full width and more padding on small screens */}
