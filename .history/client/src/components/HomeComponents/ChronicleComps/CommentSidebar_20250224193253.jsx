...
const CommentSidebar = ({ postId }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Apply separate refs to the img and div */}
        <img
        ...
        >
          <div>
            <HiArrowSmallUp
              className="text-3xl text-darkish cursor-pointer rotate-90 p-1 rounded-full border border-darkish hover:border-darker hover:text-darker"
