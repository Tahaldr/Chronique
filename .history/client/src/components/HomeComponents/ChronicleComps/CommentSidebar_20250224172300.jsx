...
const CommentSidebar = ({ postId }) => {
  ...
  return (
    <>
      <div className="w-screen h-screen fixed top-0 left-0 bg-black bg-opacity-70 z-[60] overflow-hidden select-none relative">
        {/* <motion.img
        ...
        <div className="bg-red-300 h-full w-[120%] absolute top-0 left-0">
          Lorem
        </div>
      </div>
    </>
