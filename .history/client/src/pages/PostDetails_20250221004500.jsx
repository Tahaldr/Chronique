            ...
            <div className="w-full flex flex-col gap-5">
              ...
              {loading ? (
                ...
                <>
                  ...
                  {/* Note for dragging */}
                  <div className="w-full h-10 flex items-center justify-center text-sm font-mediumPrimary text-darker">
                    <TbHandMove className="text-2xl text-darker" />
                    <p className="text-sm font-mediumPrimary text-darker">
                      Drag to scroll
                    </p>
                  </div>
                </>
