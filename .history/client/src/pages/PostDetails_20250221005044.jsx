      ...
      <div className="w-full">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="py-20 px-5 lg:py-5 lg:px-0 w-full lg:w-1/2 flex flex-col gap-20">
            ...
            {/* Author Other Posts */}
            <div className="w-full flex flex-col gap-5 mb-">
              <h4 className="font-smallSemiBold text-darker">
                You may also like
              </h4>
              {loading ? (
                ...
                <>
                  ...
                  {/* Note for dragging */}
                  <div className="w-full h-10 justify-center text-sm font-smallSemiBoldItalic text-dark flex items-center gap-1">
                    <TbHandMove />
