            ...
            <div className="w-full flex flex-col gap-5">
              ...
              {loading ? (
                ...
                <>
                  ...
                  {/* Note for dragging */}
                  <div className="w-full h-10 justify-center font-smallSemiBoldItalic text-darker flex items-center gap-1">
                    <TbHandMove className="text-base" />
                    <span className="">Drag to scroll</span>
                  </div>
                </>
              )}
            </div>
