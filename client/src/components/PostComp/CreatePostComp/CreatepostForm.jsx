...
const CreatepostForm = ({ postId, type }) => {
  ...
  return (
    <div className='w-full'>
      <form id='createpost-form' className='w-full flex flex-col gap-10' onSubmit={handleSubmit}>
        {/* post title */}
        <div
        ...
        <div
          ...
          <label
            ...
            {post.postPic === '' && (
              <div className='flex flex-col justify-center w-full h-full items-center gap-2'>
                ...
                {imageSelected ? (
                  <p className='text-lightest w-[90%] mt-3 text-center'>{imageSelected}</p>
                ) : (
                  ''
                )}
              </div>
          ...
          {post.postPic !== '' && (
            <div className='w-full h-full absolute'>
              <img src={post.postPic} className='w-full h-full object-cover z-0' alt='' />
              <button
        ...
        <div className='flex flex-wrap gap-3'>
          ...
          <input
            type='text'
            placeholder={`${
              Array.isArray(post.tags) && post.tags.length > 0 ? 'Add new tag' : 'Add a tag'
            }`}
        ...
        transition-colors duration-300 ease-in-out flex items-center justify-center ${
          ...
          {loading ? (
            ...
            <span>{type === 'update' && postId !== 'null' ? 'Edit' : 'Publish'}</span>
          )}
        </button>
      </form>
    </div>
