    ...
    <motion.div
      ...
      <div className='w-1/4 py-6 border border-darker'>
        <div className='text-darker font-smallMediumItalic px-3 hidden md:flex flex-col justify-center items-center w-full h-full text-xs lg:text-sm'>
          ...
          <p>
            &quot;In a world of fleeting moments, we capture the stories that matter most__
            insightful, bold, and unfiltered.&quot;
          </p>
        </div>
      </div>
      ...
      <div className='w-full md:w-2/4 text-center text-darkest flex items-center justify-center'>
        <AnimatePresence>
          <motion.h1
            ...
            animate={titleHovered ? { letterSpacing: '2px' } : { letterSpacing: 0 }}>
            Chronique
            {/* Line under Title  */}
      ...
      <div className='w-1/4 py-6 border border-darker'>
        <div className='text-darker font-smallMediumItalic px-3 hidden md:flex flex-col justify-center items-center w-full h-full text-xs lg:text-sm'>
          ...
          <p>
            Today {moment().format('dddd, Do MMMM, YYYY')}__ bringing you the stories that define
            the moment.
          </p>
        </div>
      </div>
