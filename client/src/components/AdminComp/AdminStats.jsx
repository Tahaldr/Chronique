      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-5 font-smallMedium">
        {stats.map((stat, index) => {
          return (
            ...
            <div
              key={index}
              className="flex w-full h-32 px-4 gap-3 bg-lightish"
            >
              {/* Tooltip */}
              <Tooltip text={stat.tooltip}>
                <div className="w-full h-full grid grid-rows-3">
                  ...
                  <div className="text-2xl md:text-3xl text-darker">
                    {stat.number}
                  </div>
                  {/* Trend */}
                  <div className="flex items-center gap-2">
                    {stat.trendstate !== "none" && (
                      <>
                        ...
                        {stat.trendstate === "down" && (
                          <MdTrendingDown className="text-red-800" />
                        )}
