      ...
      <motion.div
        ...
        <div className='py-5 px-10 w-[450px] gap-4 h-auto flex flex-col justify-center items-center'>
          ...
          <div className='w-full '>
            <form id='formSignup' className='flex flex-col gap-3' onSubmit={handleSubmit}>
              <div
                ...
                <label
                  ...
                  {image ? (
                    <p className='text-darker w-[90%] text-sm mt-3 text-center'>{image}</p>
                  ) : (
                    ''
                  )}
                </label>
            ...
            <p className=' text-dark font-mediumPrimary pt-3 flex justify-center items-center gap-2'>
              ...
              <Link to='/login'>
                <span className='text-darkest underline hover:text-darker'>Login</span>
              </Link>
            </p>
          </div>
        </div>
...
const SignupTransition = (props) => <Transition OgComponent={Signup} {...props} />;
